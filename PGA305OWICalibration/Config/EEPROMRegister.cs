...
{
    internal class EEPROMRegister
    {
        public const int EEPROM_PAGE_SIZE = 8;
        ...
        public static readonly (byte Address, byte DefaultValue) TEMP_CTRL = (0x37, 0x43);

        // need to clean this up because it is mentioned 2 times
